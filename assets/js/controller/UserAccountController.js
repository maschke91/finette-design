var userAccountEmailForm = new Form('user_account_email',
...
var userAccountPasswordForm = new Form('user_account_password',
  function (self, $self, data) {
    console.log(self, $self, data); // DEBUG
...
var userAccountPhoneForm = new Form('user_account_phone',
  function (self, $self, data) {
    console.log(self, $self, data); // DEBUG
