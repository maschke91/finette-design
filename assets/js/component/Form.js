 ...
 * @class
 */
function Form(name, success, fail, ready, notPrevent)
{
  ...
  this.resetForm = function()
  {
    ...
    var selector = self.fillString(inputsAll, {
      'attribute' : attribute
    });
  ...
  {
    var selector  = this.fillString(inputsAll, {
          'attribute' : attribute
        }),
  ...
  {
    var selector = this.fillString(messagesInput, {
      'name' : name
    });
  ...
  {
    var selector = this.fillString(message, {
      'name' : name,
      'type' : type
    });
    ...
    $.each($elements, function() {
      ...
      switch (self.typeOfElement($element)) {
        ...
        case 'radio':
          ...
          value = $(container + selector).length
            ? $(container + selector).attr('value')
            : '';
          break;
  ...
  this.setValues = function(data)
  {
    ...
    $.each($elements, function() {
      ...
      switch (self.typeOfElement($element)) {
        ...
        case 'radio':
          var selector = self.fillString(inputChecked, {
                'attribute' : attribute,
                'value'     : name
              }),
  ...
  this.validateForm = function()
  {
    ...
    var target = $(container).attr(endpoint);
